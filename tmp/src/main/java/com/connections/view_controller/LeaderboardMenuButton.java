...
/**
 * The LeaderboardMenuButton class represents a button with a leaderboard icon
 * in the menu. It extends the SVGButton class.
 */
public class LeaderboardMenuButton extends SVGButton {
	 ...
	 *
	 * @param gameSessionContext the GameSessionContext used by the leaderboard menu
	 *                           button
	 */
	...
	/**
	 * Refreshes the style of the leaderboard menu button based on the current style
	 * manager.
	 */
	@Override
